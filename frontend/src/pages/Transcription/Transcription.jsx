...
import { Vector_down, microphone, audit, vector_down,vector_send } from '../../assets';
...
export default function Transcription() {
  return (
    <div className='overflow-hidden'>
      ...
      <div className='flex justify-center flex-col py-[30px] sm:py-[80px] p-5 md:p-[100px] lg:flex-row'>
